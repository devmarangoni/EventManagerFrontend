...
export default async function registerService(user: UserRecordDto): Promise<Response<UserModel | ErrorResponseDto>> {
    try {
        ...
        const message = "Erro inesperado ao cadastrar usuário";
